...
public class AddEntities {
    ...
    public AddEntities(){
        ...
        registerEntityToSpawn(BOAR_ENTITY, EntityCategory.CREATURE, 20, 1, 3, Biomes.PLAINS, Biomes.FOREST, Biomes.TAIGA, Biomes.SWAMP, Biomes.WOODED_HILLS, Biomes.TAIGA_HILLS, Biomes.BIRCH_FOREST, Biomes.BIRCH_FOREST_HILLS, Biomes.DARK_FOREST, Biomes.DARK_FOREST_HILLS, Biomes.GIANT_TREE_TAIGA, Biomes.GIANT_TREE_TAIGA_HILLS, Biomes.WOODED_MOUNTAINS, Biomes.SUNFLOWER_PLAINS, Biomes.FLOWER_FOREST, Biomes.TAIGA_MOUNTAINS, Biomes.SWAMP_HILLS, Biomes.TALL_BIRCH_FOREST, Biomes.TAIGA_MOUNTAINS, Biomes.DARK_FOREST_HILLS, Biomes.GIANT_SPRUCE_TAIGA, Biomes.GIANT_SPRUCE_TAIGA_HILLS);
    }
