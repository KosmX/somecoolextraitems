...
public class WitchEntity extends AbstractMobLordEntity {
    ...
    protected WitchEntity(EntityType<? extends WitchEntity> type, World world) {
        super(type, world);
    ...
    protected void initDataTracker() {
        ...
        this.getAttributeInstance(EntityAttributes.GENERIC_MAX_HEALTH).setBaseValue(20d);
    ...
    public static DefaultAttributeContainer.Builder createWitchAttributes(){
        return MobEntity.createMobAttributes().add(EntityAttributes.GENERIC_ATTACK_DAMAGE, 5d)
   ...
   public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnType, @Nullable EntityData entityData, @Nullable CompoundTag entityTag){
    ...
    public boolean trySpawnMinion() {
        ...
        if (bl){
            ...
            skeleton.initialize((ServerWorldAccess) world, this.world.getLocalDifficulty(new BlockPos(x, y, z)), SpawnReason.SPAWNER, (EntityData)null, (CompoundTag)null);
            ...
            this.world.syncWorldEvent(2004, new BlockPos(skeleton.getPos()), 0);
