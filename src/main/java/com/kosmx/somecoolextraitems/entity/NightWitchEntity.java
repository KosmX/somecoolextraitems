...
public class NightWitchEntity extends AbstractMobLordEntity {

    protected NightWitchEntity(EntityType<? extends HostileEntity> type, World world) {
        super(type, world);
    ...
    private void addParticles(){
        this.world.addParticle(new DustParticleEffect(0.9f, 0.6f, 1f, 1.3f), false, this.getParticleX(0.3d) , this.getY() + this.getRandom().nextFloat()/2, this.getParticleZ(0.3d), (this.getRandom().nextFloat()-0.5f)/8, -0.1f, (this.getRandom().nextFloat()-0.5f)/8);
        this.world.addParticle(new DustParticleEffect(0.8f, 0.6f, 1f, 1.3f), false, this.getParticleX(0.5d) , this.getY() + this.getRandom().nextFloat()/3, this.getParticleZ(0.5d), (this.getRandom().nextFloat()-0.5f)/8, -0.1f, (this.getRandom().nextFloat()-0.5f)/8);
        this.world.addParticle(new DustParticleEffect(0.8f, 0.5f, 1f, 1.6f), false, this.getParticleX(0.3d) , this.getY() + this.getRandom().nextFloat()/3, this.getParticleZ(0.3d), (this.getRandom().nextFloat()-0.5f)/8, -0.1f, (this.getRandom().nextFloat()-0.5f)/8);
        this.world.addParticle(new DustParticleEffect(0.9f, 0.6f, 1f, 1.3f), false, this.getParticleX(0.7d) , this.getY() + this.getRandom().nextFloat()/6, this.getParticleZ(0.7d), (this.getRandom().nextFloat()-0.5f)/8, -0.1f, (this.getRandom().nextFloat()-0.5f)/8);
